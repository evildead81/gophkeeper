...
func (c *fileServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (FileService_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[0], "/gophkeeper_file.FileService/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fileServiceClient) DownloadFile(ctx context.Context, in *DownloadFileRequest, opts ...grpc.CallOption) (FileService_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[1], "/gophkeeper_file.FileService/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gophkeeper_file.FileService",
